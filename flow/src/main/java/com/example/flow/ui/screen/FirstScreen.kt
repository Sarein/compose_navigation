...
import com.example.main.viewmodel.FirstScreenState
...
fun FirstScreen(viewModel: FirstScreenViewModel) {
    Surface{
        ...
        when (val state = viewModelState) {
            is FirstScreenState.StartState -> FirstScreenContent(
                counter = state.counter,
                onNextScreenClick = viewModel::nextScreen,
